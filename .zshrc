...
export BEMENU_OPTS="-i --fn Roboto Normal Book 13 --line-height 24 --prompt 'Run: ' --nf #f8f8f2 --nb #282a36 --ff #50fa7b --fb #000000 --sf #507a7b --sb #000000 --hf #000000 --hb #ff79c6"
#
...
# permission fix for media directory
alias jdpfix="sudo find /mnt/linux/media -type d -exec chmod 774 {} +" 
...
# lf aliases
alias lf='lfub'
alias lfs='lf /mnt/linux/media/Series'
alias lfm='lf /mnt/linux/media/Movies'
...
export Series_D=/mnt/linux/media/Series
export Movies_D=/mnt/linux/media/Movies
